...
void __fastcall hooks::hooked_painttraverse::hook(void* ecx, void* edx, vgui::VPANEL panel, bool force_repaint, bool allow_force)
{
	//static auto o_paint = panel_hook->get_func_address <PaintTraverse_t>(41);
	...
	o_paint(ecx, panel, force_repaint, allow_force);
