...
void __fastcall hooks::hooked_postscreeneffects::hook(void* thisptr, void* edx, CViewSetup* setup)
{
	//static auto o_posteffect = clientmode_hook->get_func_address <DoPostScreenEffects_t>(44);

	if (!g_cfg.player.enable)
		return o_posteffect(thisptr, setup);
