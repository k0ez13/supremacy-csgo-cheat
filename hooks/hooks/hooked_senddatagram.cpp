...
void __fastcall hooks::hooked_packetstart::hook(void* ecx, void* edx, int incoming, int outgoing)
{
...
void __fastcall hooks::hooked_packetend::hook(void* ecx, void* edx)
{
...
bool __fastcall hooks::hooked_loosefileallowed::hook(void* ecx, void* edx)
{
	return true;
}