...
#define BASS_IOSNOTIFY_INTERRUPT_END	2	// interruption ended
	...
	{
		return reinterpret_cast<BOOL(__stdcall*)(int device, DWORD freq, DWORD flags, HWND win, const GUID * dsguid)>(BASS::bass_lib.GetProcAddressFromMemory(BASS::bass_lib_handle, _("BASS_Init")))(device, freq, flags, win, dsguid);
	}
